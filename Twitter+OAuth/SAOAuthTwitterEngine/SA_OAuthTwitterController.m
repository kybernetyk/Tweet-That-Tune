...
//	[_navBar setTintColor: [UIColor colorWithRed: (195.0f/255.0f) green: (8.0f/255.0f) blue: (8.0f/255.0f) alpha: 1.0]];
	...
	_blockerView.backgroundColor = [UIColor colorWithWhite: 0.0 alpha: 1.0];
